...
import OperatingSystemData from './OperatingSystemData';
...
const OperatingSystem = () => {
  ...
  const getChapterIcon = (chapterId) => {
    const icons = {
      os_basics: BookOpen,
      process_management: Cpu,
      synchronization_concurrency: Zap,
      memory_management: Zap,
      file_systems: FileText,
      io_device_management: Cpu,
      cpu_kernel_architecture: Target,
      security_protection: Shield,
      networking_distributed: Network,
      performance_debugging: Zap,
      interview_focus: Clock
    };
  ...
  const getChapterColor = (chapterId) => {
    const colors = {
      os_basics: 'blue',
      process_management: 'green',
      synchronization_concurrency: 'yellow',
      memory_management: 'purple',
      file_systems: 'indigo',
      io_device_management: 'pink',
      cpu_kernel_architecture: 'red',
      security_protection: 'orange',
      networking_distributed: 'teal',
      performance_debugging: 'cyan',
      interview_focus: 'amber'
    };
  ...
  const filteredChapters = OperatingSystemData.filter((chapter) => {
  ...
  const totalTopics = OperatingSystemData.reduce((acc, chapter) => acc + chapter.topics.length, 0);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
            Master core OS concepts with interactive topics, progress tracking, and interview-focused preparation
          </p>
        </div>
          ...
          <div className="flex flex-col gap-4">            
            <div className="flex gap-2 sm:gap-3">
              ...
              >
                ...
                {OperatingSystemData.map(chapter => (
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-blue-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                              </div>
                            </div>
                          );
                        })}
        ...
        <div className="mt-6 sm:mt-8 text-center text-gray-500 text-xs sm:text-sm">
          <p>
            {filteredChapters.length} of {OperatingSystemData.length} categories showing • 
