...
const LogicalReasoning = () => {
  ...
  // Filter chapters
  const filteredChapters = LogicalReasoningData.filter((chapter) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 px-3 py-4 sm:p-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-4">            
            <div className="flex gap-2 sm:gap-3">
              ...
              >
                ...
                {LogicalReasoningData.map(chapter => (
        ...
        <div className="mt-6 sm:mt-8 text-center text-gray-500 text-xs sm:text-sm">
          <p>
            {filteredChapters.length} of {LogicalReasoningData.length} categories showing • 
